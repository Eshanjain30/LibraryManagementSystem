    ...
    <br><br>
        ...
        <table border="1" cellspacing="10">
            ...
            <?php
                ...
                <td>
                <button class="btn1"><a style = "text-decoration: none;" href="edit_author.php?ai=<?php echo $row['author_id']; ?>">Edit</a></buttton>
                <button class="btn1"><a  style = "text-decoration: none;" href="delete_author.php?ai=<?php echo $row['author_id']; ?>">Delete</a></buttton>
                </td>
                </tr> 
                <?php 
                }
