...
<body>
    ...
    <form action="addbooksuccess.php" method="post" name="addbook">
    ...
    <input type="text" id="book_no" name="book_no"><br>
    <label for="book_price">Book Price:</label><br>
    <input type="text" id="book_price" name="book_price"><br>
    <br>
    <input type="submit" class="addbook" name="addbook"value="Add Book">
    </form>
    </div>
    <center>
</body>
