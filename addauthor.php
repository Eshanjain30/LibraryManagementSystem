...
<body>
    ...
    <form action="addauthorsuccess.php" method="post" name="addauthor">
    <label for="cat_name">Author Name:</label><br>
    <input type="text" id="author_name" name="author_name"><br>
    <br>
    <input type="submit" class="addauthor" name="addauthor" value="Add Author">
    </form>
    </div>
    <center>
</body>
