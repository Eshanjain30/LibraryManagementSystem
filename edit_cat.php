<?php
    ...
    $_SESSION['ci'] = $_GET['ci'];
    $cat_name='';
    $query = "select * from category where cat_id = $_GET[ci]";
...
<body>
    ...
    <br><br>
    <center>
    <div class="editcatform">
    <form action="editcatsuccess.php" method="post" name="editcat">
    <label for="cat_name">Category Name:</label><br>
    <input type="text" id="cat_name" name="cat_name" value='<?php echo $cat_name; ?>'><br>
    <br>
    <input type="submit" class="editcat" name="editcat" value="Edit Category">
    </form>
    </div>
    <center>
</body>
